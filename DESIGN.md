...
**General Data Structures: MultiDimensional array, Rectangle Shape, Cell Object**
**General Classes: Main, Simulation (For each different Simulation, e.g. GameOfLife.java, ForestFire.java, MainMenu.java, Controller.java)**
**General Methods:** 
...
![User Selection Menu:](https://github.com/brianlizhou/CellSoc/blob/master/DesignImage.jpg"UI1.png")
